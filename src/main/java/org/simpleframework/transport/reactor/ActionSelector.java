...
class ActionSelector {
    ...
    public ActionSet register(SelectableChannel channel, int interest) throws IOException {
        final SelectionKey key = channel.register(selector, interest);
    ...
    public List<ActionSet> registeredSets() {
        ...
        final Iterator<SelectionKey> ready = keys.iterator();
    ...
    private List<ActionSet> registeredSets(Iterator<SelectionKey> keys) {
        final List<ActionSet> sets = new LinkedList<ActionSet>();

        while(keys.hasNext()) {
            final SelectionKey key = keys.next();
            final ActionSet actions = (ActionSet)key.attachment();
    ...
    private List<ActionSet> selectedSets(Iterator<SelectionKey> keys) {
        final List<ActionSet> ready = new LinkedList<ActionSet>();
