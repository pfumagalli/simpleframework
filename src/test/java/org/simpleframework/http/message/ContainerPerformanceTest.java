...
public class ContainerPerformanceTest {
    ...
    public void testPerformance() throws Exception {
        ...
        final TraceAnalyzer analyzer = new DebugTraceAnalyzer(counter, false);
        final CounterContainer container = new CounterContainer(counter, latch);
        final ContainerSocketProcessor processor = new ContainerSocketProcessor(container, 50, 1);
        final Connection connection = new SocketConnection(processor, analyzer);
    ...
    private class CounterContainer implements Container {
        ...
        public void handle(Request req, Response resp) {
            try {
                ...
                final String target = req.getPath().getPath(); // parse the HTTP request URI
